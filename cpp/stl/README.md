For programming on platforms like LeetCode or in competitive programming in general, it's useful to be familiar with a wide range of standard library components in C++. Here are some important ones:
